...
namespace Bitrix24\SDK\Tests\Unit\Services\Sale\Property\Service;

use Bitrix24\SDK\Core\Contracts\CoreInterface;
use Bitrix24\SDK\Core\Exceptions\InvalidArgumentException;
use Bitrix24\SDK\Core\Result\DeletedItemBatchResult;
use Bitrix24\SDK\Services\Sale\Property\Batch as PropertyBatch;
...
#[CoversClass(PropertyBatch::class)]
class BatchTest extends TestCase
{
    ...
    public function testAddWrapsFieldsAndReturnsId(): void
    {
        ...
        $this->assertInstanceOf(PropertyAddBatchResult::class, $results[0]);
        $this->assertSame(11, $results[0]->getId());
        $this->assertInstanceOf(PropertyItemResult::class, $results[1]->property());
        $this->assertSame(['sale.property.add', ['fields' => ['xmlId' => 'a']]], $this->capturedCalls[0]);
        $this->assertSame(['sale.property.add', ['fields' => ['xmlId' => 'b']]], $this->capturedCalls[1]);
    }
    ...
    public function testUpdateSendsLowercaseIdAndFields(): void
    {
        ...
        $this->assertInstanceOf(PropertyUpdateBatchResult::class, $results[0]);
        $this->assertTrue($results[0]->isSuccess());
        $this->assertSame(5, $results[0]->property()->id);
        $this->assertSame(['sale.property.update', ['id' => '5', 'fields' => ['xmlId' => 'x']]], $this->capturedCalls[0]);
    }
    ...
    public function testDeleteSendsLowercaseId(): void
    {
        ...
        $this->assertTrue($results[0]->isSuccess());
        $this->assertSame(['sale.property.delete', ['id' => '7']], $this->capturedCalls[0]);
        $this->assertSame(['sale.property.delete', ['id' => '8']], $this->capturedCalls[1]);
    }
    ...
    public function testListUnwrapsResultKeyAndAddsIdToSelect(): void
    {
        ...
        $this->assertInstanceOf(PropertyItemResult::class, $items[0]);
        $this->assertSame(2, $items[1]->id);
        $this->assertSame('sale.property.list', $this->capturedCalls[0][0]);
    ...
    {
        return new Batch(new PropertyBatch($core, new NullLogger()), new NullLogger());
    }
}
