...
/**
 * Class PropertyUpdateBatchResult
 *
 * Result of the sale.property.update command executed in batch mode
 *
 * @package Bitrix24\SDK\Services\Sale\Property\Result
 */
class PropertyUpdateBatchResult extends UpdatedItemBatchResult
{
    #[\Override]
