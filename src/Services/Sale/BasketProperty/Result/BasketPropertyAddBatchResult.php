...
/**
 * Class BasketPropertyAddBatchResult
 *
 * Result of the sale.basketproperties.add command executed in batch mode
 *
 * @package Bitrix24\SDK\Services\Sale\BasketProperty\Result
 */
class BasketPropertyAddBatchResult extends AddedItemBatchResult
{
    #[\Override]
    public function getId(): int
    {
        return (int)$this->getResponseData()->getResult()['basketProperty']['id'];
    }
