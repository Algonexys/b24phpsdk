...
/**
 * Class PaymentItemBasketUpdatedBatchResult
 *
 * Result of the sale.paymentitembasket.update command executed in batch mode
 *
 * @package Bitrix24\SDK\Services\Sale\PaymentItemBasket\Result
 */
class PaymentItemBasketUpdatedBatchResult extends UpdatedItemBatchResult
{
    #[\Override]
    public function isSuccess(): bool
    {
        return isset($this->getResponseData()->getResult()['paymentItemBasket']);
    }
