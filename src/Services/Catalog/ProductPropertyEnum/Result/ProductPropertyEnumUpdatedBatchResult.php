...
class ProductPropertyEnumUpdatedBatchResult
{
    ...
    {
        return (int)$this->responseData->getResult()['productPropertyEnum']['id'];
    }

    public function productPropertyEnum(): ProductPropertyEnumItemResult
    {
        return new ProductPropertyEnumItemResult($this->responseData->getResult()['productPropertyEnum']);
    }
}
