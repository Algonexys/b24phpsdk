...
class Batch
{
    ...
    /**
     * Batch list of commercial catalogs
     *
     * @link https://apidocs.bitrix24.com/api-reference/catalog/catalog/catalog-catalog-list.html
     *
     * @param array<string, 'asc'|'desc'|'ASC'|'DESC'>           $order
     * @param array<string, scalar|array{0?: scalar, 1?:scalar}> $filter
     * @param array<int, string>                                 $select
     *
     * @return Generator<int, CatalogItemResult>
     * @throws BaseException
     */
    #[ApiBatchMethodMetadata(
        'catalog.catalog.list',
        'https://apidocs.bitrix24.com/api-reference/catalog/catalog/catalog-catalog-list.html',
        'Batch list of commercial catalogs'
    )]
    public function list(array $order = [], array $filter = [], array $select = [], ?int $limit = null): Generator
    {
        ...
        foreach (
            ...
            yield $key => new CatalogItemResult($value);
        }
    }
}
