...
class UpdatedUserfieldConfigItemResult extends AbstractResult
{
    /**
    ...
    {
        return new UserfieldConfigItemResult($this->getCoreResponse()->getResponseData()->getResult()['field']);
    }
}
